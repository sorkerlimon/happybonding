"""
Django settings for happybonding project.
...
SECRET_KEY = 'django-insecure-fi@^!lr^v&*tk73po!2&$vx82zn(kpg12=sk0r%u2n+66+ho_('
...
ROOT_URLCONF = 'happybonding.urls'
...
WSGI_APPLICATION = 'happybonding.wsgi.application'
